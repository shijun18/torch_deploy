...
ONNX_FILE_PATH = "unet_bladder_sim.onnx"
# logger to capture errors, warnings, and other information during the build and inference phases
TRT_LOGGER = trt.Logger()


def build_engine(onnx_file_path,engine_file_path='./engine.trt',save_engine=False):
...
def main():
    ...
    # initialize TensorRT engine and parse ONNX model
    engine, context = build_engine(ONNX_FILE_PATH,'bladder_engine.trt')
